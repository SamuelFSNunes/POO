...
//  ---------------Métodos Específicos
    ...
    // Método para desenhar a imagem :
    public void draw(Graphics g){

        g.drawImage(img.getImage(),this.posX, this.posY, this.width,
                this.height,null);
    ...
    public void getColision(int width, int height){
        ...
        // Colisão com  borda lateral Direita :
        if(this.posX+this.width>width) {
            this.posX = width - this.width;
            this.sound.play();
        }
        // Colisão com  borda lateral Esquerda :
        if(this.posX<0){
            this.posX=0;
            this.sound.play();
        }
